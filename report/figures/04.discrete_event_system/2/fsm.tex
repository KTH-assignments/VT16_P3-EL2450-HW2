\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=1.8cm,
  ...
  \node[state]         (07) [right of=06]       {(P,I,E)};
  ...
  \node[state]         (13) [right of=12]       {(D,I,E)};
  ...
  \path (02) edge [bend left] node {\texttt{TAKEN}}         (01)
        (02) edge [bend left] node {\texttt{START(2)}}      (03)
        (02) edge [bend left] node {\texttt{START(1)}}      (07);
  ...
  \path (06) edge [bend left] node {\texttt{REPAIR(2)}}     (02)
  ...
  \path (08) edge [bend left] node {\texttt{END(1)}}        (02)
        ...
        (08) edge [bend left] node {\texttt{END(2)}}        (10)
  ...
  \path (10) edge [bend left] node {\texttt{END(1)}}        (03)
  ...
  \path (12) edge [bend left] node {\texttt{END(1)}}        (06)
  ...
  \path (13) edge [bend left] node {\texttt{REPAIR(1)}}     (01)
        ...
        (13) edge [bend left] node {\texttt{START(2)}}      (16);
