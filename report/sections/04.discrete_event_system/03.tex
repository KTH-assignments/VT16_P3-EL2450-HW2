...
Nince transitions are removed, bringing the total number of transitions between
states of the complete DES to $57$. The transition function $\delta()$ is shown
in table \ref{tbl:04.03_delta} and the new state machine diagram is illustrated
in figure \ref{fig:fsm_3} of the appendix.
